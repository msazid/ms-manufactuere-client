                ...
                <div className="">
                    <div className="row">
                        <div className="col-12 col-md-6 col-lg-3 ">
                            <div className="card mx-auto my-1 my-lg-0 mx-md-0" style={{ width: '18rem', border: 'none' }}>
                        ...
                        <div className="col-12 col-md-6 col-lg-3">
                            <div className="card mx-auto my-1 my-lg-0 mx-md-0" style={{ width: '18rem', border: 'none' }}>
                                <div className="card-body">
                                    <h5 className="card-title text-center"><svg xmlns="http://www.w3.org/2000/svg" style={{ width: '64px', color: '#FF8C32' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
